...
Esta guía explica cómo compilar y ejecutar RisuBard directamente en un teléfono Android usando Termux. El patrón de uso previsto es abrir `http://localhost:7777` en el navegador del propio teléfono.
