...
export const languageEnglish = {
    ...
    lorebookWorkspace: {
        ...
        bardAnalysisSettingHelp: {
            ...
            analysisInputTokens: "The per-request input-token allowance for instructions, output schema, and entry text. Analysis cannot start when one entry exceeds it.",
        ...
        loreBuilder: {
            ...
            undo: "Previous draft",
            applyDraft: "Apply to current entry",
    ...
    risuBardGrimoireInstructionDescription: "This read-only code-owned instruction is sent to Grimoire analysis. Its marked slot is filled with character-specific facet keys, then source lore is appended at request time.",
