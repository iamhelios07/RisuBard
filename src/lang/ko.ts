...
export const languageKorean = {
  ...
  lorebookWorkspace: {
    ...
    bardAnalysisSettingHelp: {
      ...
      analysisInputTokens: "요청 한 번에 보낼 분석 지시문, 출력 형식, 항목 본문을 합친 입력 토큰 한도입니다. 항목이 이 한도를 넘으면 요청을 시작할 수 없습니다.",
    ...
    bardActivationHelp: "이 항목을 항상 필수로 넣을지, 키·별칭 적중이나 키+관련도 검색으로 선택할지, 자동 주입에서 제외할지 정합니다.",
    bardRequired: "항상 필수",
    bardKeyed: "키·별칭 적중",
    bardRetrieve: "키+관련도",
    bardNever: "자동 주입 안 함",
    ...
    bardGuideWritingActivationBody: "항상 필수는 모든 요청에 필요한 시스템 계약에만 사용합니다. 이름이 분명한 실체와 엄격히 여는 비밀은 키·별칭 적중, 관련 표현으로도 찾아야 하는 일반 세계관은 키+관련도, 모델이 자동으로 사용하면 안 되는 참고 자료는 자동 주입 안 함을 사용하세요.",
  ...
  risuBardGrimoireInstructionDescription: "Grimoire 분석에 실제로 전달되는 읽기 전용 프로그램 지시문입니다. 표시된 슬롯은 요청 시 캐릭터별 패싯 키로 채우고 원본 로어를 뒤에 추가합니다.",
