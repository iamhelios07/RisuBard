...
<div class="chat-settings" data-chat-risubard-settings>
    ...
    <label><span>위키 조회 제한 시간(ms)</span><input type="number" min="1" max="10000" step="500" value={settings.risuBardInquiryTimeoutMs} onchange={(event) => setNumber('risuBardInquiryTimeoutMs', event)} /></label>
