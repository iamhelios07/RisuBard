...
const declarativeSources: DeclarativeSource[] = [
    { items: risuBardCommonSettingsItems, route: SettingsRoute.RisuBardCommon },
    ...
    { items: advancedContextItems, route: SettingsRoute.Advanced, subTab: 0, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.context, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.context.title },
    { items: advancedPromptItems, route: SettingsRoute.Advanced, subTab: 0, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.context, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.prompts.title },
    { items: advancedRequestItems, route: SettingsRoute.Advanced, subTab: 1, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.request, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.request.title },
    { items: advancedResponseItems, route: SettingsRoute.Advanced, subTab: 1, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.request, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.response.title },
    { items: advancedInterfaceItems, route: SettingsRoute.Advanced, subTab: 2, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.features, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.interface.title },
    { items: advancedFeatureItems, route: SettingsRoute.Advanced, subTab: 2, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.features, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.features.title },
    { items: advancedUtilityItems, route: SettingsRoute.Advanced, subTab: 2, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.features, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.utilities.title },
    { items: advancedExperimentalItems, route: SettingsRoute.Advanced, subTab: 3, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.experimental, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.experimental.title },
    { items: advancedCompatibilityItems, route: SettingsRoute.Advanced, subTab: 3, tabLabel: () => language.settingsWorkspace.advancedWorkspace.tabs.experimental, sectionLabel: () => language.settingsWorkspace.advancedWorkspace.sections.compatibility.title },
