...
export function setDatabase(data:Database){
    ...
    ensureGlobalLorebookPageIds(data.loreBook, uuidv4)
    ...
    data.risuBardAnalysisTokenLimit = normalizeRisuBardAnalysisTokenLimit(
        data.risuBardAnalysisTokenLimit
    )
    data.risuBardAdditionalSearchLimit = normalizeRisuBardAdditionalSearchLimit(
        data.risuBardAdditionalSearchLimit
    )
    ...
    const wikiPromptState = normalizeWikiPromptPresetState({
        ...
        chatPresetId: data.risuBardChatWikiPromptPresetId,
    }, uuidv4)
...
export function normalizeChat(chat: Partial<Chat>): Chat {
    ...
    ensureStableLorebookOwnerId(c, uuidv4)
...
export interface MessageGenerationInfo{
    ...
    maxContext?: number
    toolUsed?: boolean
    risuBardContext?: import('../risubard/memoryActivity').RisuBardContextTrace
    stageTiming?: {
        stage1?: number
        stage2?: number
        stage3?: number
